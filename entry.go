...
func NewEntry(key, value string, mark uint16) *Entry {
	return &Entry{
		Key:       key,
		Value:     value,
...
func (e *Entry) GetEntrySize() int64 {
...
func (e *Entry) Encode() ([]byte, error) {
	...
	copy(buf[entryHeaderSize:entryHeaderSize+e.KeySize], []byte(e.Key))
	copy(buf[entryHeaderSize+e.KeySize:], []byte(e.Value))
	return buf, nil
}
